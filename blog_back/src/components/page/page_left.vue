...
<el-submenu index="2">
    ...
    <router-link to="/index/add_list">
        <el-menu-item index="2-1">分类列表</el-menu-item>
    </router-link>
    <router-link to="/index/add_class_one">
        <el-menu-item index="2-2">增加一级分类</el-menu-item>
    </router-link>
    <router-link to="/index/add_class_two">
        <el-menu-item index="2-3">增加二级分类</el-menu-item>
    </router-link>
</el-submenu>
<el-submenu index="3">
    <template slot="title"><i class="el-icon-setting"></i>接口管理</template>

    <router-link to="/index/add_api">
        <el-menu-item index="3-1">增加接口文档</el-menu-item>
    </router-link>
    <router-link to="/index/api_list_font">
        <el-menu-item index="3-2">前台接口列表</el-menu-item>
    </router-link>
    <router-link to="/index/api_list_back">
